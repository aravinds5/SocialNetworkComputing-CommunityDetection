...
public class ModularityOptimizer extends Applet
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        else
        {
            ...
            */
            inputFileName = "D:\\dataset.txt";
            outputFileName = "D:\\result.txt";
        ...
        Clustering [] clusterings=new Clustering[nIterations]; 
        ...
        for (i = 0; i < nRandomStarts; i++)
        {
            ...
            do
            {
                ...
                //System.out.format("clusterings[j]="+j);
                clusterings[j-1]=new Clustering(clustering);
            }
        ...
        updateGraph(network,clusterings);
    ...
    private static void updateGraph(Network network,Clustering[] clusterings){
    	boolean update=true;
    	network.nodecolor=new int[network.getNNodes()];
    	for (int k=0;k<clusterings.length;k++)
    	{   		
    		Clustering c=clusterings[k];
    		if (c==null)
    		{	
    			System.out.println("return at "+k);
    			return;
    		}
	    	for(int i=0;i<network.getNNodes();i++)
	    	{
		    	int color=c.getCluster(i);
		    	network.nodecolor[i]=color;
		    }
    	}
    }
